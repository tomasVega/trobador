...
class Administracion_Form_Editarusuario extends Zend_Form {
    ...
    public function __construct($options=null){
        ...
        $this->setAction('/administracion/usuarios/gestionusuarios');
        $this->setMethod('post');
        ...
        $activo->addMultiOption(0, Zend_Registry::get('Zend_Translate')->translate('m097'));
        ...
        $this->addElements(array($idUsuario, $nombre, $email, $roles, $activo, $submit));
